...
@Component({
    selector: 'app-special-services-counts-tab-component',
    standalone: true,
    ...
    templateUrl: './special-services-counts-tab-component.html',
    styleUrl: './special-services-counts-tab-component.scss',
})
export class SpecialServicesCountsTabComponent {
    // ---- Inputs as signals
