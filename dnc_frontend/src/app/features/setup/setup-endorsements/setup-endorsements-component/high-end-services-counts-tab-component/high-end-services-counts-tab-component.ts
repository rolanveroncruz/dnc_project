...
// ✅ CHANGED: update this import path to wherever DentalService lives in your app
import {DentalService} from '../../../../../api_services/dental-services-service';

@Component({
    selector: 'app-high-end-services-counts-tab-component',
    standalone: true,
    ...
    templateUrl: './high-end-services-counts-tab-component.html',
    styleUrl: './high-end-services-counts-tab-component.scss',
})
export class HighEndServicesCountsTabComponent {
    // ---- Inputs as signals
    ...
    // Optional: normalize to integer when leaving the field
