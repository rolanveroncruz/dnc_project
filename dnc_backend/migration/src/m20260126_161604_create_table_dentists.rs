        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .index( Index::create()
                        .name("dentist_name_contract_unique")
                        .table(Dentist::Table)
                        .col(Dentist::LastName)
                        .col(Dentist::GivenName)
                        .col(Dentist::MiddleName)
                        .col(Dentist::AccreDentistContractId)
                        .unique()
                    )
                    .to_owned()
            ).await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .index(
                        Index::create()
                            .name("dentist_clinic_dentist_id_clinic_id_position_unique")
                            .table(DentistClinic::Table)
                            .col(DentistClinic::DentistId)
                            .col(DentistClinic::ClinicId)
                            .col(DentistClinic::PositionId)
                            .unique()
                    )
                        .to_owned()
            ).await?;
