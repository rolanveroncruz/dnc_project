...
// The DentistHmoAuditCell reprents an intersection between an Hmo and a dentist in the audit matrix.
// The DentistHmoAuditServiceLine represents the services performed by that dentist for the hmo.
#[derive(Debug, Serialize)]
...
// It has dentist information, as well as list of AutditCells
#[derive(Debug, Serialize)]
