...
pub async fn upload_endorsement_master_list(
    ...
    for (zero_based_idx, row) in range.rows().enumerate().skip(1) {
        ...
        // Your columns are 1-based:
        // col 5 -> index 4 = CorporateNumber
        // col 6 -> index 5 = AccountNumber
        // col 7 -> index 6 = LastName
        // col 8 -> index 7 = FirstName
        // col 9 -> index 8 = MiddleName
        ...
        tracing::info!("row_number:{}: corporate_number:{}\t a_n:{}\t l_name:{}\t f_name:{}\t m_name:{}\n",
        ...
        // Check duplicate against rows already queued in this same upload
        ...
        // Check duplicate against existing DB rows
